        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Enrolled = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address3 = table.Column<string>(maxLength: 150, nullable: true),
                    SubjectCount = table.Column<int>(maxLength: 150, nullable: true)
                },
                constraints: table =>
                {
